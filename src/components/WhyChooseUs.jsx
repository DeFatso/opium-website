...
// Import your custom images instead of Unsplash
  ...
  const features = [
    {
      ...
      description: "ISO-certified components and rigorous testing ensure every solution meets the highest industry standards.",
      delay: "0.1s"
    },
    {
      id: 2,
      ...
      description: "Round-the-clock technical assistance and on-site support to minimize your operational downtime.",
      delay: "0.2s"
    },
    {
      id: 3,
      ...
      description: "Cutting-edge hydraulic solutions with continuous R&D to keep your operations ahead of the curve.",
      delay: "0.3s"
    },
    {
      id: 4,
      ...
      description: "20+ years of combined experience with certified hydraulic specialists at your service.",
      delay: "0.4s"
    }
  ];
      ...
      <div className="container">
        ...
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Discover why industry leaders trust Hyses for their most critical hydraulic and engineering needs
          </p>
        </div>
